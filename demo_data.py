    ...
    return {
        ...
        },
        {
            ...
            "param_values": {
                ...
                "pmc_time": 110.0,                # Warning
                "cooling_rate": 4.0,              # Normal
                "warpage_mm": 0.08                # Normal
            }
        },
        {
            "stage_name": "Solder Reflow",
            "weight": stage_weights["reflow"],
            "param_values": {
                "floor_life_hours": 60.0,         # Warning
                "moisture_content": 0.25,         # Normal
                "reflow_peak_temp": 245.0,        # Normal
                "reflow_ramp_rate": 2.8,          # Normal
                "time_above_liquidus": 100.0      # Normal
            }
        }
    ],
    ...
    "Lot E - Cumulative Risk Stop": [
        ...
        },
        {
            ...
            "param_values": {
                ...
                "reflow_ramp_rate": 3.3,
                "time_above_liquidus": 135.0
            }
        }
    ]
...
def get_historical_lot_quality_data():
    return [
        ...
        {"Lot ID": "LOT-002", "Overall Risk": 0.13, "Risk Class": "Low", "Final Status": "Completed"},
        {"Lot ID": "LOT-003", "Overall Risk": 0.11, "Risk Class": "Low", "Final Status": "Completed"},
        {"Lot ID": "LOT-004", "Overall Risk": 0.14, "Risk Class": "Low", "Final Status": "Completed"},
